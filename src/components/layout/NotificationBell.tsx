    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <>
          ...
          <div
            className={cn(
              "fixed left-2 right-2 top-16 z-50 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-1 sm:w-80",
              "rounded-xl bg-white shadow-modal border border-gray-100 animate-slide-up overflow-hidden"
            )}
          >
